    ...
    C: Has<XSpanIdString> + Has<Option<AuthData>> + Clone + Send + Sync + 'static,
{
        ...
        context: &C) -> Result<GetGenerationsResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = serde_json::from_str::<Vec<models::Generation>>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {}", e))
                })?;
                Ok(GetGenerationsResponse::OK
                    (body)
                )
            }
            code => {
    ...
    async fn get_generations_record_id(
        &self,
        param_record_id: String,
        context: &C) -> Result<GetGenerationsRecordIdResponse, ApiError>
    {
        let mut client_service = self.client_service.clone();
        let mut uri = format!(
            "{}/mocks/college-app/college-app/406762/generations/{record_id}",
            self.base_path
            ,record_id=utf8_percent_encode(&param_record_id.to_string(), ID_ENCODE_SET)
        );
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::Generation>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {}", e))
                })?;
                Ok(GetGenerationsRecordIdResponse::OK
                    (body)
                )
            }
            404 => {
        ...
        context: &C) -> Result<GetGroupsResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<Vec<models::Group>>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {}", e))
                })?;
                Ok(GetGroupsResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<GetGroupsRecordIdResponse, ApiError>
    {
        let mut client_service = self.client_service.clone();
        let mut uri = format!(
            "{}/mocks/college-app/college-app/406762/groups/{record_id}",
            self.base_path
            ,record_id=utf8_percent_encode(&param_record_id.to_string(), ID_ENCODE_SET)
        );
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::Group>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {}", e))
                })?;
                Ok(GetGroupsRecordIdResponse::OK
                    (body)
                )
            }
            404 => {
        ...
        context: &C) -> Result<GetSocialBrandsResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<Vec<models::SocialBrand>>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {}", e))
                })?;
                Ok(GetSocialBrandsResponse::OK
                    (body)
                )
            }
            code => {
        ...
        context: &C) -> Result<GetUsersResponse, ApiError>
    {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<Vec<models::User>>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {}", e))
                })?;
        ...
        context: &C) -> Result<GetUsersRecordIdResponse, ApiError>
    {
        let mut client_service = self.client_service.clone();
        let mut uri = format!(
            "{}/mocks/college-app/college-app/406762/users/{record_id}",
            self.base_path
            ,record_id=utf8_percent_encode(&param_record_id.to_string(), ID_ENCODE_SET)
        );
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(GetUsersRecordIdResponse::OK
                    (body)
                )
            }
            404 => {
    ...
    async fn post_login(
        &self,
        param_login_request: Option<models::LoginRequest>,
        context: &C) -> Result<PostLoginResponse, ApiError>
    {
        ...
        let body = param_login_request.map(|ref body| {
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::LoginResponse>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {}", e))
                })?;
                Ok(PostLoginResponse::OK
                    (body)
                )
            }
            401 => {
    ...
    async fn put_users(
        &self,
        param_update_user_request: Option<models::UpdateUserRequest>,
        context: &C) -> Result<PutUsersResponse, ApiError>
    {
        ...
        let body = param_update_user_request.map(|ref body| {
            serde_json::to_string(body).expect("impossible to fail to serialize")
        });
