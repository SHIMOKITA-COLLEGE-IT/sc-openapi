...
import {
    ...
    PutUsersRequestFromJSON,
    PutUsersRequestToJSON,
    UserFromJSON,
    UserToJSON,
} from '../models';
...
export interface PutUsersOperationRequest {
...
export class DefaultApi extends runtime.BaseAPI {
     ...
     * Get Generations
     */
    async getGenerationsRaw(requestParameters: GetGenerationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * Get Generations
     */
    async getGenerations(requestParameters: GetGenerationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
     ...
     * Get Users
     */
    async getUsersRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        const queryParameters: any = {};
     ...
     * Get Users
     */
    async getUsers(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
     ...
     * Search Users (WIP)
     */
    async getUsersSearchRaw(requestParameters: GetUsersSearchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
     ...
     * Search Users (WIP)
     */
    async getUsersSearch(requestParameters: GetUsersSearchRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
     ...
     * Update User
     */
    async putUsersRaw(requestParameters: PutUsersOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: PutUsersRequestToJSON(requestParameters.putUsersRequest),
        }, initOverrides);
     ...
     * Update User
     */
    async putUsers(requestParameters: PutUsersOperationRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
