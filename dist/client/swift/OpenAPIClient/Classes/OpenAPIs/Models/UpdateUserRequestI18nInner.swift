//
// UpdateUserRequestI18nInner.swift
//
...
public struct UpdateUserRequestI18nInner: Codable, JSONEncodable, Hashable {
    ...
    public init(locale: Locale, firstName: String? = nil, lastName: String? = nil, phoneticFirstName: String? = nil, phoneticLastName: String? = nil, nickName: String? = nil, middleName: String? = nil, phoneticMiddleName: String? = nil, maidenName: String? = nil, _prefix: String? = nil, suffix: String? = nil) {
        self.locale = locale
